...
def generate_data(data, size=1000):
    ...
    while i < size and i < len(data.test_data):
        ...
        paths.append(data.test_paths[i])
    ...
    return inputs, targets, reals, paths
...
class ResultLogger(object):
    def __init__(self, path, flags):
        ...
        self.results_fh.write('index, real, target, queries, l_0, l_2, l_inf, time\n')
        self.time_total = 0.0
